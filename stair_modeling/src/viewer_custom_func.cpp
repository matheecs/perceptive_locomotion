...
void addActorToRenderer(pcl::visualization::PCLVisualizer &viewer,
...
bool myaddText(pcl::visualization::PCLVisualizer &viewer,
  ...
  if (am_it != shape_actor_map_->end()) {
    pcl::console::print_warn(stderr,
                             "[addText] A text with id <%s> already exists! "
...
void createActorFromVTKDataSet(pcl::visualization::PCLVisualizer &viewer,
...
//////////////////////////////////////////////////////////////////////////////////////////
bool removeActorFromRenderer(pcl::visualization::PCLVisualizer &viewer,
...
bool myaddPolygon(
  ...
  if (am_it != shape_actor_map_->end()) {
    ...
    // Add old data
#if VTK_MAJOR_VERSION < 6
    all_data->AddInput(reinterpret_cast<vtkPolyDataMapper *>(
